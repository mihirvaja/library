			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="dateBorrowed-label" class="property-label"><g:message code="book.dateBorrowed.label" default="Date Borrowed" /></span>
						...
						<span class="property-value" aria-labelledby="dateBorrowed-label"><g:formatDate date="${bookInstance?.dateBorrowed}" /></span>
				...
				<li class="fieldcontain">
					<span id="returnDate-label" class="property-label"><g:message code="book.returnDate.label" default="Return Date" /></span>
						...
						<span class="property-value" aria-labelledby="returnDate-label"><g:formatDate date="${bookInstance?.returnDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="student-label" class="property-label"><g:message code="book.student.label" default="Student" /></span>
						...
						<span class="property-value" aria-labelledby="student-label"><g:link controller="student" action="show" id="${bookInstance?.student?.id}">${bookInstance?.student?.encodeAsHTML()}</g:link></span>
